...
responses %<>% relocate(across(starts_with(now_words), -now_words), before = now_words)
responses %<>% relocate(across(starts_with(grew_words), -grew_words, before = grew_words))
```
